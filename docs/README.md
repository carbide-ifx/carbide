# iFX architecture documentation

This directory describes what iFX is made of and how the pieces fit together. It is design
...
Read [Getting started](getting-started.md) first if you have not used iFX before. Then, in order:

| Document | Answers |
| --- | --- |
| [Getting started](getting-started.md) | How do I define a contract, host it, and call it — the tutorial path |
| [Architecture overview](architecture.md) | What is iFX, what are its planes and layers, how does a call get from a caller to a service |
